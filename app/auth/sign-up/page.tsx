...
import { signUpWithGithub, type AuthActionState } from "./actions"
import Link from "next/link"

export default function SignUpPage() {
  const [state, formAction, isPending] = useActionState(signUpWithGithub, null)
      ...
      <div className="w-full max-w-sm space-y-8 rounded-2xl border border-gray-800 bg-gray-900/80 p-8 shadow-2xl backdrop-blur-xl">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-400">
            Get started in seconds using your GitHub account
          </p>
        </div>
        ...
        <form action={formAction} className="space-y-4">
          ...
          >
            ...
            {isPending ? "Redirecting to GitHub..." : "Sign up with GitHub"}
          </button>
        </form>
